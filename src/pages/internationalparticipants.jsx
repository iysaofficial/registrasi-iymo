...
export default function Internationalparticipants() {
  ...
  useEffect(() => {
    const scriptURL =
      "https://script.google.com/macros/s/AKfycbzxU9QpaR0ItIwLkBHXWN5X6pzYBpiALobC4ifoDCMWKDUV0AwVx1morjpkbFfYV0XZ/exec";
      ...
      <section className="registration-section">
        <div class="container">
          <div class="content">
            ...
            <br />
            <h4>
              HELLO IYMO 2024 PARTICIPANTS, Please consider the following
              ...
              <div className="user-details">
                ...
                <div class="input-box">
                  <label for="INFORMATION_RESOURCES" class="form-label">
                    IYMO 2024 Competition Information Resources
                  </label>
                  <select
                    type="text"
