...
function IndoensiaParticipants() {
  ...
  const generatePaymentLink = async () => {
    if (
      selectedCategory !== "IYMO Online Competition" &&
      selectedCategory !== "IYMO Offline Competition" 
    ) {
      alert(
  ...
  useEffect(() => {
    if (selectedCategory === "IYMO Online Competition") {
      setPrice("300000");
    } else if (selectedCategory === "IYMO Offline Competition") {
      setPrice("1150000");
    } else {
      setPrice("");
    }
  ...
  useEffect(() => {
    const scriptURL =
      "https://script.google.com/macros/s/AKfycbyHZT-vge9Fcxj3SfvekxHLcyAL6hZqrPK1LlpJ-aH-F3nQbUedy02HoG4Zin0-3eOB/exec";
      ...
      <section className="registration-section">
        <div className="container">
          <div className="content">
            ...
            <br></br>
            <h4>
              HALLO PESERTA IYMO 2024, Mohon perhatikan informasi berikut ini
              ...
              <div className="user-details">
                <div className="input-box">
                  ...
                  >
                    ...
                    <option value="IYMO Online Competition">
                      Kompetisi Online
                    </option>
                    <option value="IYMO Offline Competition">
                      Kompetisi Offline
                    </option>
                  </select>
                </div>
              ...
              <div className="user-details">
                ...
                <div className="input-box">
                  <label for="SUMBER_INFORMASI" className="form-label">
                    Sumber Informasi Kompetisi IYMO 2024
                  </label>
                  <select
                    type="text"
                    id="SUMBER_INFORMASI"
